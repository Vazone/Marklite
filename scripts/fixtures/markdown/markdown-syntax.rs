...
mod models {
    pub mod app_error { include!(concat!(env!("MARKLITE_TEST_ROOT"), "/src-tauri/src/models/app_error.rs")); }
...
mod services {
    ...
    pub mod markdown_service { include!(concat!(env!("MARKLITE_TEST_ROOT"), "/src-tauri/src/services/markdown_service.rs")); }
    pub mod math_service { include!(concat!(env!("MARKLITE_TEST_ROOT"), "/src-tauri/src/services/math_service.rs")); }
}
mod utils {
    pub mod security { include!(concat!(env!("MARKLITE_TEST_ROOT"), "/src-tauri/src/utils/security.rs")); }
}
